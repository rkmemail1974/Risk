...
WebsocketRails::EventMap.describe do
    subscribe :client_connected, to: WelcomeController, with_method: :new
    subscribe :client_connected, to: WelcomeController, with_method: :client_connected
